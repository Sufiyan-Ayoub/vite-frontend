                    ...
                    <div className='flex flex-col gap-4 p-4 border rounded'>
                        ...
                        <div className='flex gap-4'>
                            ...
                            <div className="flex gap-2">
                                <div className="flex-1 flex flex-col gap-2">
                                    <Label>Profit</Label>
                                    <Input type="number" disabled value={profit} placeholder="--" />
                                </div>
                                <div className="flex-1 flex flex-col gap-2">
                                    <Label>Margin (%)</Label>
                                    <Input type="text" disabled value={margin} placeholder="--" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            {variants.map((v) => (
                                <div
                                    ...
                                    className="
                                        ...
                                        first:rounded-t-md first:border-t
                                        last:border-b last:rounded-b-md
                                    "
                                >
                                    {/* Variant Info */}
                                    <div className="flex-1 flex flex-col gap-2">
                                        <div className="font-medium">{v.nm}</div>
                                        <div className="text-sm text-gray-500 flex items-center gap-2">
                                            <Badge variant="secondary">Stock: {v.stock}</Badge>
                                            <Badge variant="secondary">Price: ${v.price}</Badge>
                                            <Badge variant="secondary">Cost: ${v.costPerItem}</Badge>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex gap-2">
                                        <EditVariant ID={v.ID} />
                                        <Button variant="secondary" className='text-red-600' size="sm" onClick={() => onDelete(v.ID)} title="Delete Variant">
                                            <Trash2 size={16} />
                                        </Button>
                                    </div>
                                </div>
